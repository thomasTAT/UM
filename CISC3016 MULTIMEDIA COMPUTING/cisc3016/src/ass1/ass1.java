...
public class ass1 {
	public static void main(String args[]) {
		String fName ="src/mediasources/anya.png";
		//pict.show();
		...
		Picture pict2 = new Picture(pict.getWidth(),pict.getHeight()*2);
		pict2.collage(pict,0,0);
		pict2 = pict2.MirrorXaix();
		pict = pict.copyPicture(585,271,1052,750);
		pict2.collage(pict,1079,505);
		pict2.show();
		pict2.write("src/ass1/ass1.png");
